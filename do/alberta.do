...
xline($mass2502w) text(400 $mass2502w "A  ", place(w) orientation(horizontal) size(small)) ///
xline($schools2w) text(400 $schools2w "B  ", place(w) orientation(horizontal) size(small)) ///
xline($mass502w) text(400 $mass502w "C  ", place(w) orientation(horizontal) size(small)) ///
xline($enforce2w) text(400 $enforce2w "D  ", place(w) orientation(horizontal) size(small)) ///
xline($mass152w) text(400 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
...
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
"E: Mass gatherings restricted to 15 people, plus 3 weeks", size(vsmall))
...
xline($mass152w) text(150 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(350 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(2 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xlabel(${xstart}(7)${xend}, angle(45)) ///
xline($mass2502w) text(18 $mass2502w "A  ", place(w) orientation(horizontal) size(small)) ///
xline($schools2w) text(18 $schools2w "B  ", place(w) orientation(horizontal) size(small)) ///
xline($mass502w) text(18 $mass502w "C  ", place(w) orientation(horizontal) size(small)) ///
xline($enforce2w) text(18 $enforce2w "D  ", place(w) orientation(horizontal) size(small)) ///
xline($mass152w) text(18 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(15 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(25 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(5 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(10 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
...
xline($mass152w) text(8 $mass152w "E  ", place(w) orientation(horizontal) size(small)) ///
note("A: Mass gatherings restricted to 250 people, plus 3 weeks" ///
"B: Schools closed, plus 3 weeks" ///
"C: Mass gatherings restricted to 50 people, plus 3 weeks" ///
"D: Enforcement of mandatory publich health orders, plus 3 weeks" ///
