...
* Cumulative cases
twoway (connected cumu_cases_100k day_100 if CountryCode == "CAN", lcolor(red)) ///
(connected cumu_cases_100k day_100 if CountryCode == "$country", lcolor(blue)), ///
...
* Cumulative deaths
twoway (connected cumu_deaths_100k day_100 if CountryCode == "CAN", lcolor(red)) ///
(connected cumu_deaths_100k day_100 if CountryCode == "$country", lcolor(blue)), ///
